...
class WatsonVC: JSQMessagesViewController {
    ...
    let DIALOG_ID = "eb11b66c-4e60-42f0-9c01-d03e77d199dc"
    // WatsonDialogサービスのサービス資格情報
    let DIALOG_USER = "788b6bad-e24d-44dc-92f4-e99ea05da902"
    let DIALOG_PASS = "GyPfXrOJg6Jw"
    var conversationId: String = ""
    var clientId: String = ""
    
    // Natural Language Classifier(NLC)APIリクエスト時に必要となるユニークなClassifierId
    let CLASSIFIER_ID_TITLE = "foodhealth"
    let CLASSIFIER_ID_STARRING = "17aa0ex79-nlc-531"
    // WatsonNLCサービスのサービス資格情報
    let NLC_USER = "424f06f3-88bb-4c31-b444-9a4caea26158"
    let NLC_PASS = "pqxH3HyFu5wW"
    ...
    override func viewDidLoad() {
        ...
        // アバターの設定
        self.incomingAvatar = JSQMessagesAvatarImageFactory.avatarImageWithImage(UIImage(named: "2.gif")!, diameter: 64)
        self.outgoingAvatar = JSQMessagesAvatarImageFactory.avatarImageWithImage(UIImage(named: "1.png")!, diameter: 64)
